# Changes that need to be made to the analysis pipeline
...
# Completed:
- Modify producer to output correct data
- Modify azimuthalBinning to output q-arrays for both masks that are the same
- Modify azimuthalBinning to do the correct geometry optimization
- Edit Compare_Runs.ipynb
- Edit Geometry_Calibration.ipynb
- Edit Knife_Edge.ipynb if needed (No edits requied)
